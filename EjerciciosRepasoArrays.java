 ...
 */
package ejerciciosrepasoarrays1;
 ...
 * @author Naia
 */
public class EjerciciosRepasoArrays {

    //Array de 10 posiciones
            static int [] listaNumeros = new int [3];
    ...
    public static void main(String[] args) {
        ...
        String listaMenu = JOptionPane.showInputDialog("1. Mostrar el contenido de todas las posiciones." + "\n" +
                                                       ...
                                                       "6. Ordenar los números de mayot a menor." + "\n" +
                                                       "7. Salir." + "\n" +
        ...
        switch(listaMenu){
            ...
            case "7": salir();
            break;
            default: JOptionPane.showMessageDialog(null, "Escribe bien el número.");
